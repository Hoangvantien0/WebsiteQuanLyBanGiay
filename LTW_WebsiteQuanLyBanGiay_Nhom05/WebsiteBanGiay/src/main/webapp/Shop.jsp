            ...
            <section>
              ...
              <section class="mb-4">
                ...
                <div class="md-form md-outline mt-0 d-flex justify-content-between align-items-center">
                  <input oninput="searchByName(this)" value="${txtS}" name="txt" type="text" class="form-control mb-0" placeholder="Giày Nike...">
              ...
              <div class="col-12 col-md-5">
                <div class="d-flex flex-wrap">
                  <div class="select-outline position-relative w-100">
                    ...
                    <p style="font-weight: bold; text-transform: uppercase;">Tất cả sản phẩm</p>
