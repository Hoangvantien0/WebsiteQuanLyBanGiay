      ...
      <section class="mb-5">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="table-responsive">
              <table class="table table-sm table-borderless mb-0">
                <tbody>
                  ...
                  <tr>
                    <th class="pl-0 w-25" scope="row"><strong>Nơi Gửi</strong></th>
           ...
           <button type="submit" class="btn btn-light btn-md mr-1 mb-2"><i class="fas fa-shopping-cart pr-2"></i>Thêm Vào Dỏ Hàng</button>
              </div>
              </form>
      ...
      <div class="classic-tabs">
        ...
        <div class="tab-content" id="advancedTabContent">
          ...
          <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
            <h5><span>(${countAllReview })</span> Đánh Giá Cho Giày<span>${detail.name }</span></h5>
